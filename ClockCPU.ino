...
void loop()
{
	...
	if (Option == 2)
	{
		...
		// displays solar current on screen
		displaySolarCurrMsg();
	...
	lightLEDBasedOnVDelta(0, LEDA);
	lightLEDBasedOnVDelta(3, LEDB);
	lightLEDBasedOnVDelta(6, LEDC);
	lightLEDBasedOnVDelta(9, LEDD);
	lightLEDBasedOnVDelta(12, LEDE);
	...
	if (Option == 3)
	{
		...
		else if (((millis() - OptionCount) < 2500) && (Option == 3) && (Sync == 1))
		{
			if (l == 0)
			{
				OptionCount = millis();
		...
		else if (((millis() - OptionCount) > 5000) && (Sync == 0))
		{
			Option = 0;
			k = 0;
			l = 0;
	...
	if (Option == 4)
	{
		...
		else if (((millis() - OptionCount) < 5000) && (Option == 4) && (Sync == 1))
		{
			if (o == 0)
			{
				OptionCount = millis();
...
void displaySolarCurrMsg() {
	if (((millis() - OptionCount) > 5000) && (Sync == 0))
	{
		Option = 0;
		k = 0;
	}
	else if (((millis() - OptionCount) > 40000) && (Sync == 1))
	{
		Option = 0;
		k = 0;
		Sync = 0;
	}
	else if (((millis() - OptionCount) < 250) && (Option == 2))
	{
		matrix.writeDigitRaw(0, S);
		matrix.writeDigitRaw(1, O);
	...
	else if (((millis() - OptionCount) > 500) && ((millis() - OptionCount) < 750) && (Option == 2) && (Sync == 0))
	{
	...
	else if (((millis() - OptionCount) > 750) && ((millis() - OptionCount) < 1000) && (Option == 2) && (Sync == 0))
	{
	...
	else if (((millis() - OptionCount) > 1000) && ((millis() - OptionCount) < 1250) && (Option == 2) && (Sync == 0))
	{
	...
	else if (((millis() - OptionCount) > 1250) && ((millis() - OptionCount) < 1500) && (Option == 2) && (Sync == 0))
	{
	...
	else if (((millis() - OptionCount) > 1500) && ((millis() - OptionCount) < 1750) && (Option == 2) && (Sync == 0))
	{
		matrix.writeDigitRaw(0, BLANK);
	...
	else if (((millis() - OptionCount) > 1750) && ((millis() - OptionCount) < 2000) && (Option == 2) && (Sync == 0))
	{
	...
	else if (((millis() - OptionCount) > 2250) && ((millis() - OptionCount) < 2500) && (Option == 2) && (Sync == 0))
	{
	...
	else if (((millis() - OptionCount) > 2500) && ((millis() - OptionCount) < 2750) && (Option == 2) && (Sync == 0))
	{
		matrix.writeDigitRaw(0, R);
		matrix.writeDigitRaw(1, R);
	...
	else if (((millis() - OptionCount) > 2750) && ((millis() - OptionCount) < 3000) && (Option == 2) && (Sync == 0))
	{
		matrix.writeDigitRaw(0, R);
...
void lightLEDBasedOnVDelta(int delta, int led) {
	if ((VDelta > delta) && (Option == 2))
	{
